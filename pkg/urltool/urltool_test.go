...
func TestGetBasePath(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{name: "基本事例", args: args{targetUrl: "https://www.liwenzhou.com/posts/Go/golang-menu"}, want: "golang-menu", wantErr: false},
		{name: "无效的url事例", args: args{targetUrl: "/xxxx/1123"}, want: "", wantErr: true},
